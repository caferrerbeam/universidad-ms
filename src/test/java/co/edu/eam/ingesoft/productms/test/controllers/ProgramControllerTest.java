...
public class ProgramControllerTest {
  ...
  public static final String FIND_ALL_PROGRAMS = Router.PROGRAMS_PATH
      + Router.FIND_ALL_PROGRAMS;
  public static final String FIND_BY_NAME = Router.PROGRAMS_PATH
      + Router.FIND_BY_NAME;
  public static final String FIND_BY_ID = Router.PROGRAMS_PATH
      + Router.FIND_PROGRAMS;
  public static final String SAVE = Router.PROGRAMS_PATH
      + Router.CREATE_PROGRAMS;
  public static final String EDIT = Router.PROGRAMS_PATH + Router.EDIT_PROGRAMS;
  public static final String DELETE = Router.PROGRAMS_PATH
      + Router.DELETE_PROGRAMS;
  ...
  public void listAllTest() throws Exception {
    ...
    programRepository.saveAll(Lists.list(new Program(1, "software", 1),
        new Program(2, "industrial", 2)));

    mockMvc.perform(get(FIND_ALL_PROGRAMS)).andExpect(status().isOk())
        .andExpect(jsonPath("$", hasSize(2)))
        .andExpect(jsonPath("$[0].name", is("software")))
        .andExpect(jsonPath("$[1].name", is("industrial")));
  ...
  public void listByNameEmptyTest() throws Exception {
    mockMvc.perform(get(FIND_BY_NAME + "?name=software"))
  ...
  public void save() throws Exception {
    ...
    mockMvc
        .perform(
            post(SAVE).content(content).contentType(MediaType.APPLICATION_JSON))
  ...
  public void edit() throws Exception {
    ...
    mockMvc
        .perform(
            put(EDIT).content(content).contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  ...
  public void del() throws Exception {
    programRepository.saveAll(Lists.list(new Program(1, "software", 1)));
    mockMvc
        .perform(delete(DELETE + "/1").contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
